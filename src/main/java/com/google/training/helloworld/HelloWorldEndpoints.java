...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    public HelloClass greetByFullName(@Named("name") String name, @Named("secondName") String SecondName, @Named("ThirdName") String ThirdName){
    	return new HelloClass(name, SecondName, ThirdName);
    }
